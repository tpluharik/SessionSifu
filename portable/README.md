...
The current 3.3.0 manager includes encrypted visual Privacy Recall. It is off by default;
...
Version 3.3.0 adds accessibility-first text indexing on supported Linux
...
Version 3.3.0 bundles the pinned Czech and English Tesseract language models in
