...
The 2.2 manager includes experimental Privacy Recall. It is off by default and
...
dedicated `Ctrl+Alt+Space` search popup are available on every portable target.
