...
The current 3.2.3 manager includes encrypted visual Privacy Recall. It is off by default;
...
Version 3.2.3 bundles the pinned Czech and English Tesseract language models in
