...
gjs -m "$project_dir/tests/restore-safety-smoke.js"
node --experimental-vm-modules "$project_dir/tests/restore-queue-smoke.mjs"
node --experimental-vm-modules "$project_dir/tests/compositor-operations-smoke.mjs"
node --experimental-vm-modules "$project_dir/tests/recall-lifecycle-smoke.mjs"
node --experimental-vm-modules "$project_dir/tests/power-policy-smoke.mjs"
...
python3 "$project_dir/tests/test_audit_regressions.py"
python3 "$project_dir/tests/test_marketplace.py"
...
install -m 0644 "$project_dir/portable/sessionsifu_portable/vault_key.py" "$stage/usr/lib/sessionsifu/vault_key.py"
install -m 0644 "$project_dir/app/recall_engine.py" "$stage/usr/lib/sessionsifu/recall_engine.py"
install -m 0644 "$project_dir/portable/sessionsifu_portable/semantic.py" "$stage/usr/lib/sessionsifu/semantic.py"
install -m 0644 "$project_dir/portable/sessionsifu_portable/restore_journal.py" "$stage/usr/lib/sessionsifu/restore_journal.py"
install -m 0644 "$project_dir/portable/sessionsifu_portable/mcp.py" "$stage/usr/lib/sessionsifu/mcp.py"
install -m 0644 "$project_dir/portable/sessionsifu_portable/capsule.py" "$stage/usr/lib/sessionsifu/capsule.py"
...
install -m 0644 "$project_dir/docs/WINDOW_RULES.md" "$stage/usr/share/doc/sessionsifu/docs/WINDOW_RULES.md"
...
install -m 0644 "$project_dir/docs/STABILITY_AUDIT.md" "$stage/usr/share/doc/sessionsifu/docs/STABILITY_AUDIT.md"
install -m 0644 "$project_dir/docs/SANDBOXED_WORKSPACES.md" "$stage/usr/share/doc/sessionsifu/docs/SANDBOXED_WORKSPACES.md"
