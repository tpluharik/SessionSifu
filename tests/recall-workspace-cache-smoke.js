...
try {
    ...
    if (await Cache.restorePreview(42, restored, Cache.CACHE_MAX_AGE_SECONDS, 'different page'))
        throw new Error('A changed window context reused stale screenshot pixels');
    if (await Cache.restorePreview(42, restored, -1))
