...
with tempfile.TemporaryDirectory(prefix="sessionsifu-package-test-") as directory:
    ...
    installed_support_modules = [
        ...
        for name in ("semantic.py", "restore_journal.py", "mcp.py", "capsule.py", "vault_key.py")
    ]
    ...
    assert health_check.stdout.strip() == "semantic.py,restore_journal.py,mcp.py,capsule.py,vault_key.py"
