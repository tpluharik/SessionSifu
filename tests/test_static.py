...
assert metadata["version-name"] == "3.5.18"
assert metadata["version"] == 52
...
assert 'version="3.5.18"' in build_script
...
assert 'CURRENT_VERSION = "3.5.18"' in app_source
...
assert "## Shipped foundation — 3.5.18" in roadmap
