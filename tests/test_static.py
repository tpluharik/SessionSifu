...
assert metadata["version-name"] == "3.5.15"
...
assert 'version="3.5.15"' in build_script
...
assert 'CURRENT_VERSION = "3.5.15"' in app_source
...
assert "## Shipped foundation — 3.5.15" in roadmap
