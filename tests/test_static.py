...
assert metadata["version-name"] == "3.5.20"
assert metadata["version"] == 54
...
assert 'version="3.5.20"' in build_script
...
assert 'CURRENT_VERSION = "3.5.20"' in app_source
...
assert "## Shipped foundation — 3.5.20" in roadmap
