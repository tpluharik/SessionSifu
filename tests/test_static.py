...
assert metadata["version-name"] == "3.5.13"
assert metadata["version"] == 48
...
assert 'version="3.5.13"' in build_script
...
assert 'CURRENT_VERSION = "3.5.13"' in app_source
...
assert "## Shipped foundation — 3.5.13" in roadmap
