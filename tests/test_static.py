...
assert metadata["version-name"] == "3.5.25"
assert metadata["version"] == 59
...
assert 'version="3.5.25"' in build_script
...
assert 'CURRENT_VERSION = "3.5.25"' in app_source
...
assert "## Shipped foundation — 3.5.25" in roadmap
