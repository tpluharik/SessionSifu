...
assert metadata["version-name"] == "3.5.23"
assert metadata["version"] == 57
...
assert 'version="3.5.23"' in build_script
...
assert 'CURRENT_VERSION = "3.5.23"' in app_source
...
assert "## Shipped foundation — 3.5.23" in roadmap
