...
assert metadata["version-name"] == "3.5.19"
assert metadata["version"] == 53
...
assert 'version="3.5.19"' in build_script
...
assert 'CURRENT_VERSION = "3.5.19"' in app_source
...
assert "## Shipped foundation — 3.5.19" in roadmap
