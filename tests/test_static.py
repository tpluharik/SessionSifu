...
assert metadata["version-name"] == "3.5.22"
assert metadata["version"] == 56
...
assert 'version="3.5.22"' in build_script
...
assert 'CURRENT_VERSION = "3.5.22"' in app_source
...
assert "## Shipped foundation — 3.5.22" in roadmap
