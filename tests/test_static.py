...
assert metadata["version-name"] == "3.5.21"
assert metadata["version"] == 55
...
assert 'version="3.5.21"' in build_script
...
assert 'CURRENT_VERSION = "3.5.21"' in app_source
...
assert "## Shipped foundation — 3.5.21" in roadmap
