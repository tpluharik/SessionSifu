...
assert metadata["version-name"] == "3.5.24"
assert metadata["version"] == 58
...
assert 'version="3.5.24"' in build_script
...
assert 'CURRENT_VERSION = "3.5.24"' in app_source
...
assert "## Shipped foundation — 3.5.24" in roadmap
