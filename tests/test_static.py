...
assert metadata["version-name"] == "3.5.12"
assert metadata["version"] == 47
...
assert 'version="3.5.12"' in build_script
...
assert 'CURRENT_VERSION = "3.5.12"' in app_source
...
assert "## Shipped foundation — 3.5.12" in roadmap
