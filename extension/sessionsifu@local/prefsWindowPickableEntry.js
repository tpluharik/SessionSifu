...
export const WindowPickableEntry = GObject.registerClass({
    ...
    _initEntry(entry) {
        ...
        chooseButton.connect('clicked', (source, pickedWidget) => {
            ...
            Gio.DBus.session.call(
                ...
                'org.gnome.Shell.Extensions.SessionSifu.PickWindow', 'PickWindow',
    ...
    _subscribeSignal(signalName, callback) {
        const dbusConnection = Gio.DBus.session.signal_subscribe(
            'org.gnome.Shell', 'org.gnome.Shell.Extensions.SessionSifu.PickWindow',
            signalName,
            '/org/gnome/shell/extensions/sessionsifu', null, Gio.DBusSignalFlags.NONE,
            callback);
