...
// properly for the SessionSifu extension.
...
export const WindowPickerServiceProvider = class WindowPickerServiceProvider {
  ...
  constructor() {
    const iFace = new TextDecoder().decode(
      FileUtils.current_extension_dir.get_child('dbus-interfaces').get_child('org.gnome.Shell.Extensions.SessionSifu.PickWindow.xml').load_contents(null)[1]);
  ...
  enable() {
    this._dbus.export(Gio.DBus.session, '/org/gnome/shell/extensions/sessionsifu');
  }
