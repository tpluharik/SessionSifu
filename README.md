...
Version 3.5.24 coordinates launches, window layout and Recall screenshots through
...
bounded capture buffering. GNOME safety pacing remains in place. See the
[audit and verification notes](docs/STABILITY_AUDIT.md) for recovery instructions
...
On GNOME, version 3.5.24 saves application metadata across every workspace and
