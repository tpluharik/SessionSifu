...
This document describes the 3.5.13 runtime and release layout. User-facing
...
window previews. Version 3.5.13 uses serialized screenshot-area requests only for
