...
This document describes the 3.5.8 runtime and release layout. User-facing
...
window previews. Version 3.5.8 uses serialized screenshot-area requests only for
